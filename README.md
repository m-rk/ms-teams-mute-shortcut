...
Open the app once. Its menu bar icon appears and its native macOS login item is enabled automatically. You can turn **Launch at Login** off or back on from the helper's menu.
